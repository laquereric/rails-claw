...
ActiveRecord::Schema[8.1].define(version: 2026_02_28_112001) do
  ...
  create_table "models", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["api_model_id"], name: "index_models_on_api_model_id"
    t.index ["name"], name: "index_models_on_name"
    t.index ["provider_id"], name: "index_models_on_provider_id"
  end
  ...
  add_foreign_key "models", "providers"
end
